            ...
            <ul class="space-y-2">
                <?php $__currentLoopData = $belumDiulas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="flex items-center justify-between text-sm">
                        <span class="text-slate-700"><?php echo e($t->lokasi_warung); ?> &middot; <?php echo e($t->created_at->format('d M Y')); ?></span>
                        <a href="<?php echo e(route('titipan.show', $t)); ?>" class="text-blue-700 font-medium hover:underline">Beri Ulasan &rarr;</a>
                    </li>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $diterima; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="bg-white rounded-2xl border border-slate-200 p-4 shadow-sm transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                        <div class="flex items-center justify-between">
                            <p class="font-medium text-slate-800"><?php echo e($u->dariUser?->name); ?></p>
                            <span class="text-blue-500 text-sm"><?php echo e(str_repeat('★', $u->rating)); ?><?php echo e(str_repeat('☆', 5-$u->rating)); ?></span>
                        </div>
                        <?php if($u->komentar): ?><p class="text-sm text-slate-500 mt-1">"<?php echo e($u->komentar); ?>"</p><?php endif; ?>
                        <p class="text-xs text-slate-400 mt-2"><?php echo e($u->titipan?->lokasi_warung); ?> &middot; <?php echo e($u->created_at->diffForHumans()); ?></p>
                    </div>
        ...
        <div>
            ...
            <div class="space-y-3">
                <?php $__empty_1 = true; $__currentLoopData = $diberikan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="bg-white rounded-2xl border border-slate-200 p-4 shadow-sm transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                        <div class="flex items-center justify-between">
                            <p class="font-medium text-slate-800">Untuk <?php echo e($u->untukUser?->name); ?></p>
                            <span class="text-blue-500 text-sm"><?php echo e(str_repeat('★', $u->rating)); ?><?php echo e(str_repeat('☆', 5-$u->rating)); ?></span>
                        </div>
                        <?php if($u->komentar): ?><p class="text-sm text-slate-500 mt-1">"<?php echo e($u->komentar); ?>"</p><?php endif; ?>
                        <div class="flex items-center justify-between mt-2">
                            <p class="text-xs text-slate-400"><?php echo e($u->titipan?->lokasi_warung); ?> &middot; <?php echo e($u->created_at->diffForHumans()); ?></p>
